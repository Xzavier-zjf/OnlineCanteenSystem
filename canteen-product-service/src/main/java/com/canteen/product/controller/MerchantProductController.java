...
public class MerchantProductController {
    ...
    public Long getMerchantProductCount(HttpServletRequest request, @PathVariable Long merchantId) {
    ...
    public List<Map<String, Object>> getTopProducts(HttpServletRequest request,
    ...
    public Result<Map<String, Object>> getMerchantProductList(HttpServletRequest httpRequest,
                                                              @PathVariable Long merchantId,
    ...
    public Result<String> addProduct(HttpServletRequest httpRequest,
                                    @PathVariable Long merchantId,
    ...
    public Result<String> updateProduct(HttpServletRequest httpRequest,
    ...
    public Result<String> deleteProduct(HttpServletRequest httpRequest,
                                       @PathVariable Long productId,
                                       @RequestParam Long merchantId) {
        try {
            merchantId = requireCurrentMerchant(httpRequest, merchantId);
    ...
    public Result<String> updateProductStatus(HttpServletRequest httpRequest,
                                             @PathVariable Long productId,
                                             @RequestParam Long merchantId,
    ...
    public Result<String> updateProductStock(HttpServletRequest httpRequest,
                                            @PathVariable Long productId,
                                            @RequestParam Long merchantId,
    ...
    public Result<Map<String, Object>> getProductDetail(HttpServletRequest httpRequest,
                                                       @PathVariable Long productId,
                                                       @RequestParam Long merchantId) {
        try {
            merchantId = requireCurrentMerchant(httpRequest, merchantId);
